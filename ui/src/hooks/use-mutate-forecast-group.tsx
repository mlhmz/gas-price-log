import type { ForecastGroupMutation, ForecastGroupQuery } from "@/types/ForecastGroup";
...
export const useMutateForecastGroup = ({ onSuccess }: { onSuccess: Dispatch<ForecastGroupQuery> }) => {
    return useMutation({
